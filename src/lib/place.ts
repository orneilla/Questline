...
const GROUPES: Groupe[] = [
  ...
  },
  {
    cle: "ciqual",
    nom: "Table Ciqual",
    aide: "Les aliments de référence et leurs teneurs. Déposée une fois, ne grandit plus.",
    fixe: true,
    tables: ["cuisine_aliments"],
  },
  {
    cle: "cuisine",
    nom: "Cuisine",
    aide: "Recettes, patrons de plat, inventaire, courses, repas notés.",
    fixe: false,
    tables: [
      "cuisine_recettes",
  ...
  {
    cle: "calendrier",
    nom: "Calendriers extérieurs",
    aide: "Les créneaux déroulés depuis les flux. Remplacés à chaque relecture, jamais accumulés.",
    fixe: false,
    tables: ["evenements_importes", "calendriers_abonnes", "categories_creneau", "regles_categorie"],
  },
  {
    cle: "prieres",
    nom: "Suivi des prières",
    aide: "Une ligne par prière cochée. Quelques octets chacune.",
    fixe: false,
    tables: ["prieres_faites", "reglages_prieres"],
  },
  {
    cle: "sauvegardes",
    nom: "Sauvegardes",
...
export async function repartitionBase(): Promise<Repartition> {
  ...
  if (divers > 0) {
    postes.push({
      ...
      aide: "Journal des migrations, tables techniques, et tout module ajouté depuis.",
      fixe: false,
      octets: divers,
      lignes: [],
    });
